      ...
      <div className="bg-white rounded-2xl border border-border overflow-hidden">
        ...
        <div className="border-b border-border bg-surface/30 p-4">
          <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-6">
            ...
            <select value={paymentStatus} onChange={(event) => { setPaymentStatus(event.target.value); setPage(1); }} className="input-field py-2 text-sm" aria-label="Payment status"><option value="">All payment statuses</option><option value="pending">Unpaid</option><option value="processing">Payment processing</option><option value="partially_paid">Partially paid</option><option value="completed">Paid</option><option value="failed">Payment failed</option><option value="refunded">Refunded</option><option value="partially_refunded">Partially refunded</option></select>
